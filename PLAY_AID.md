# Gridiron Dice Football - Play Aid

## Drive Outcome Tables

Roll a d20 (0-19) and consult the table for your chosen play style.

**Format:** Yards / Time Blocks

### Drive Outcome Comparison

| Roll | Balanced | Run-First | Pass-First |
|------|----------|-----------|------------|
|  0   | -10 / 4      | -2 / 12      | -10 / 2      |
|  1   | 0 / 5        | 0 / 12       | -5 / 3       |
|  2   | 3 / 6        | 2 / 12       | 0 / 4        |
...
|  8   | 15 / 11      | 12 / 17      | 22 / 9       |
|  9   | 18 / 14      | 15 / 18      | 28 / 12      |
| 10   | 25 / 17      | 18 / 20      | 35 / 15      |
| 11   | 32 / 19      | 22 / 22      | 42 / 17      |
| 12   | 38 / 22      | 26 / 24      | 50 / 20      |
| 13   | 45 / 26      | 30 / 27      | 60 / 24      |
| 14   | 55 / 31      | 34 / 32      | 70 / 29      |
| 15   | 68 / 38      | 38 / 35      | 80 / 36      |
| 16   | **TD** / 1-20 | 42 / 39      | **TD** / 1-20 |
| 17   | **TD** / 1-20 | 60 / 40      | **TD** / 1-20 |
| 18   | **TD** / 1-20 | 90 / 45      | **TD** / 1-20 |
| 19   | **TD** / 1-20 | **TD** / 1-20 | **TD** / 1-20 |

---

## Detailed Tables by Style

### Balanced Offense

| Roll | Yards | Time Blocks | Notes |
|------|-------|-------------|-------|
|  0   | -10   |  4          |       |
|  1   |   0   |  5          |       |
|  2   |   3   |  6          |       |
...
| 14   |  55   | 31          |       |
| 15   |  68   | 38          |       |
| 16   | TD    | 1-20        | Roll 1d20, cap by yards needed |
| 17   | TD    | 1-20        | Roll 1d20, cap by yards needed |
| 18   | TD    | 1-20        | Roll 1d20, cap by yards needed |
| 19   | TD    | 1-20        | Roll 1d20, cap by yards needed |
...
### Field Position
- Field coordinates: 0 (Bombers goal) to 100 (Gunners goal)
- Kickoffs start at team's own 30-yard line
- Field goal range: Within 35 yards of opponent's goal

### Time
- Each half: 180 time blocks (30 minutes game time)
...
1. Roll 1d20 for time
2. Find the smallest non-TD row with yards ≥ yards needed
3. Use the minimum of the d20 roll and that row's time

### Late Half Rule
If time remaining is less than the drive time:
- Use the largest non-TD row that leaves ≥1 block
- If in FG range, attempt FG and half ends
- Otherwise, half ends immediately

### Play Style Selection (AI)
**With ≤60 blocks remaining (~10 min):**
- Trailing: 55% Pass, 35% Balanced, 10% Run
- Leading: 50% Run, 40% Balanced, 10% Pass
- Tied: 40% Pass, 45% Balanced, 15% Run

**Otherwise:**
- 50% Balanced, 30% Pass, 20% Run

---

*Generated by Gridiron Dice Football Simulator*
